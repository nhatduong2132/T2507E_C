...
public class ProductManager {
    ...
    public static void main(String[] arg) {
        ...
        products.add(new ElectronicProduct("E003", "EProduct 3", 1_000_000.0, 12));
        products.add(new ClothingProduct("C003", "Clothing Product 3", 99_999_999.0, "M"));
        products.add(new FoodProduct("C003", "Clothing Product 3", 99_999_999.0, 30));
